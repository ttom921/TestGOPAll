...
var mp3Header = void 0;
var Mp3Parser = function () {
    createClass(Mp3Parser, null, [{
        key: 'getHeaderLength',
        value: function getHeaderLength(data) {
            return 4;
            //return (data[1] & 0x01 ? 7 : 9);  // without CRC 7 and with CRC 9 Refs: https://wiki.multimedia.cx/index.php?title=ADTS
        ...
        key: 'isMp3Pattern',
        value: function isMp3Pattern(data) {
            return data[0] === 0xff;
            //return data[0] === 0xff && (data[1] & 0xf0) === 0xf0 && (data[1] & 0x06) === 0x00;
        }
    }, {
        key: 'extractMp3',
        value: function extractMp3(buffer) {
            var i = 0,
                length = buffer.byteLength,
                result = [],
                headerLength = void 0,
            ...
            if (!Mp3Parser.isMp3Pattern(buffer)) {
                error('Invalid mp3 audio format');
                return result;
            }
        ...
        key: 'getMp3HeaderData',
        get: function get$$1() {
            return mp3Header;
        }
    }]);

    function Mp3Parser(remuxer) {
        classCallCheck(this, Mp3Parser);

        this.remuxer = remuxer;
        this.track = remuxer.mp4track;
    }

    createClass(Mp3Parser, [{
        key: 'setMp3Config',
        value: function setMp3Config() {
            var objectType = void 0,
                sampleIndex = void 0,
                channelCount = void 0,
                config = new Uint8Array(2),
...
var MP4 = function () {
    ...
    createClass(MP4, null, [{
        ...
        value: function box(type) {
            ...
            // size = box_size + box_header + box_body
...
var Mp3Remuxer = function (_BaseRemuxer) {
    inherits(Mp3Remuxer, _BaseRemuxer);

    function Mp3Remuxer() {
        classCallCheck(this, Mp3Remuxer);

        var _this = possibleConstructorReturn(this, (Mp3Remuxer.__proto__ || Object.getPrototypeOf(Mp3Remuxer)).call(this));
        ...
        _this.samples = [];
        _this.mp3 = new Mp3Parser(_this);
        return _this;
    }

    createClass(Mp3Remuxer, [{
        key: 'resetTrack',
        value: function resetTrack() {
            this.readyToDecode = false;
            this.mp4track.codec = '';
...
var RemuxController = function (_Event) {
    ...
    createClass(RemuxController, [{
        key: 'addTrack',
        value: function addTrack(options) {
...
var JMuxmer = function (_Event) {
    ...
    function JMuxmer(options) {
        ...
        _this.remuxController.addTrack(_this.options); // both, audio, video
    ...
    createClass(JMuxmer, [{
        ...
        key: 'getAudioFrames',
        value: function getAudioFrames(audioFrames, duration) {
            var samples = [],
                units = void 0,
                sampleDuration = void 0,
                adjustDuration = 0;
            ...
            try {
                for (var _iterator2 = audioFrames[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    units = _step2.value;
        ...
        value: function createBuffer() {
            ...
            for (var type in this.remuxController.tracks) {
                ...
                if (type == 'audio') {
                    ...
                    sb = this.mediaSource.addSourceBuffer('audio/mpeg');
                } else if (type == 'video') {
