...
測試單純連線200個沒有輸資料。目前只有記憶體增加0.1G

### 測試讀取資料夾

使用不是標準的[FileSystemDirectoryEntry](https://developer.mozilla.org/en-US/docs/Web/API/FileSystemDirectoryEntry)的使用是可以得到資夾下面的所有的檔案
